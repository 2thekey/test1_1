...
var num=List.generate(1200,(i) => List(8), growable:false);
// ignore: non_constant_identifier_names
List input_Num=[1,12,13,24,29,44];
          ...
          body: Column(
            ...
            children: <Widget>[
              TextField(
                keyboardType: TextInputType.number,
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: '함께나온 수 찾기(1번 ~ 45번 중에서 입력)',
                  ),
              ...
              RaisedButton(
                child: Text('같이나온 수'),
                onPressed: () {
                  var imsinum=int.parse(myController.text);
              ...
              // Text('$input_Num'),
              // Text('1등 회차:  $dangchum1'),
              // Text('2등 회차:  $dangchum2'),
              // Text('3등 회차:  $dangchum3'),
              // Text('4등 회차:  $dangchum4'),
              // Text('5등 회차:  $dangchum5'),
   ...
   dangchum5.add(0);
    ...
    for (int i =1 ; i < last_soonbun; i++) {
      ...
      switch(dang) {
        ...
        case 5 : if(num[i][7]==input_Num[0] ||  num[i][7]==input_Num[1] || num[i][7]==input_Num[2] || num[i][7]==input_Num[3] || num[i][7]==input_Num[4] || num[i][7]==input_Num[5])
          {
